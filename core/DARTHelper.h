...
dart::dynamics::FreeJoint::Properties* MakeFreeJointProperties(const std::string& name,const Eigen::Isometry3d& parent_to_joint = Eigen::Isometry3d::Identity(),const Eigen::Isometry3d& child_to_joint = Eigen::Isometry3d::Identity(), const Eigen::VectorXd& lower = Eigen::VectorXd::Zero(6), const Eigen::VectorXd& upper = Eigen::VectorXd::Zero(6), const Eigen::VectorXd& springStiff = Eigen::VectorXd::Zero(6));
dart::dynamics::PlanarJoint::Properties* MakePlanarJointProperties(const std::string& name,const Eigen::Isometry3d& parent_to_joint = Eigen::Isometry3d::Identity(),const Eigen::Isometry3d& child_to_joint = Eigen::Isometry3d::Identity(),const Eigen::Vector3d& lower = Eigen::Vector3d::Constant(-2.0),const Eigen::Vector3d& upper = Eigen::Vector3d::Constant(2.0),const Eigen::Vector3d& springStiff = Eigen::Vector3d::Constant(300),const Eigen::Vector3d& damping = Eigen::Vector3d::Constant(300), const std::string& plane = "XY");
