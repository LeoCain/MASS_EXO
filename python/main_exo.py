...
class PPO(object):
	...
	def SaveModel(self):
		self.model.save('../nn_exo/current.pt')
		self.muscle_model.save('../nn_exo/current_muscle.pt')
		
		if self.max_return_epoch == self.num_evaluation:
			self.model.save('../nn_exo/max.pt')
			self.muscle_model.save('../nn_exo/max_muscle.pt')
		if self.num_evaluation%100 == 0:
			self.model.save('../nn_exo/'+str(self.num_evaluation//100)+'.pt')
			self.muscle_model.save('../nn_exo/'+str(self.num_evaluation//100)+'_muscle.pt')

	def LoadModel(self,path):
		self.model.load('../nn_exo/'+path+'.pt')
		self.muscle_model.load('../nn_exo/'+path+'_muscle.pt')
